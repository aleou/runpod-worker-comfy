...
# --------------------------------------------------------
  ...
  RUN apt-get update && apt-get install -y \
      python3.10 python3-pip git wget aria2 libgl1 vim \
  ...
  && pip install opencv-contrib-python-headless scikit-image diffusers accelerate imageio-ffmpeg color-matcher sageattention segment_anything piexif
  ...
  RUN if [ "$MODEL_TYPE" = "Wan" ]; then \
      ...
      aria2c -x16 -s16 -d models/diffusion_models -o Wan2_1-I2V-14B-480P_fp8_e4m3fn.safetensors \
